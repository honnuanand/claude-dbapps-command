...
class DatabricksDeployer:
    def __init__(self):
        ...
        self.app_name = "APP_NAME_PLACEHOLDER"
    ...
    def copy_static_files(self) -> bool:
        ...
        if exit_code != 0:
            print(f"❌ Failed to copy static files: {stderr}")
            return False
    ...
    def package_backend(self) -> bool:
        ...
        # Ensure app.yaml is copied
        app_yaml_src = os.path.join("backend", "app.yaml")
...
def main():
    ...
    parser.add_argument("--app-name", default="APP_NAME_PLACEHOLDER", help="App name")
